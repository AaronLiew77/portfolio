...
const COUNTDOWN_FROM = "2024-08-22";
...
const ShiftingCountdown = () => {
  return (
    <div className="bg-gradient-to-br from-yellow-600 to-indigo-600 p-4">
            
      <div className="mx-auto flex w-full max-w-5xl items-center bg-white rounded-lg">
        <CountdownItem unit="Day" text="days" />
        <CountdownItem unit="Hour" text="hours" />
        <CountdownItem unit="Minute" text="minutes" />
        <CountdownItem unit="Second" text="seconds" />
        <h1 className="flex text-3xl font-bold leading-tight text-center items-center justify-center">
        End of my Degree :D
        </h1>
      </div>
